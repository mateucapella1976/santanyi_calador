...
var config_default = defineConfig({
  branch: "main",
  clientId: "f72b08a7-f53f-433c-aee9-03dc09dbb510",
  token: "ca9887baff2e1b57b9ed44e105f3c6b982ed18b5",
  build: {
    outputFolder: "admin",
    publicFolder: "public"
  },
    ...
    collections: [
      ...
      // ─── HORARIS ──────────────────────────────────────────────────────
      {
        ...
        fields: [
          ...
          // ── Activitats (logos) ──
          {
            type: "object",
            name: "activitats",
            label: "\u{1F3F7}\uFE0F Activitats (logos)",
            list: true,
            ui: { itemProps: (item) => ({ label: item?.nom || "Activitat" }) },
            fields: [
          ...
          // ── Files horari Santanyí ──
          {
            ...
            list: true,
            ui: { itemProps: (item) => ({ label: item?.hora || "Hora" }) },
            fields: [
      ...
      // ─── PÀGINA NEWSLETTER ────────────────────────────────────────────
      {
        ...
        fields: [
          ...
          { type: "string", name: "heroSubtitleEn", label: "Subt\xEDtol hero (EN)" },
          { type: "string", name: "heroSubtitleDe", label: "Subt\xEDtol hero (DE)" },
          { type: "string", name: "edicio", label: "Edici\xF3 (ex: Vol. 7 Edici\xF3 Gener 2026)" },
